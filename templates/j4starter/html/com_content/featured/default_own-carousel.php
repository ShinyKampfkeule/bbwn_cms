<?php
    ...
    $icCounter = 0;
?>
<div id="carouselExampleIndicators" class="news__carousel carousel slide height-100 width-100" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <?php foreach ($this -> news_arr as $key => $item) : ?>
            ...
            <div class="carousel-item<?php if ( $firstElement === FALSE ) : ?><?php echo " active" ?><?php endif; ?>">
                ...
                <div class="news__carousel__content">
                    <h2 class="news__carousel__content__heading heading2"><?php echo( $item -> title ) ?></h2>
